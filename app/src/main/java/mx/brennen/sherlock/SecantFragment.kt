...
import kotlinx.android.synthetic.main.fragment_secant.*
...
class SecantFragment : Fragment() {

    private var variable = ' '
    private var width = 0f
    private var DESMOS_STATE = false
    private var iterations : ArrayList<IteracionS> = ArrayList()
        ...
        calculate.onClick {
            ...
            if(editAInput.text!!.toString() != "" && editBInput.text!!.toString() != ""
                ...
                if (DESMOS_STATE){
                    ...
                    desmos.evaluateJavascript("javascript:setMathModel(\'${math.simplify(editFunctionInput.text.toString())}\')",null)
                        ...
                        try {
                            ...
                            if(edittoleranceInput.text.toString().toInt()>1){
                                ...
                                doAsync {
                                    ...
                                    iterations = NM.secant(editFunctionInput.text.toString(),
                                        editvarInput.text.toString(), doubleArrayOf(a,b), math.tolerance("10^-1000"),
                                        edittoleranceInput.text.toString().toInt()).clone() as ArrayList<IteracionS>
                                    textInputtolerance.isErrorEnabled = false
                    ...
                    "Tolerancia" -> {
                        ...
                        doAsync {
                            ...
                            iterations = NM.secant(editFunctionInput.text.toString(),
                                ...
                                ,0).clone() as ArrayList<IteracionS>
    ...
    private fun getIterationsFalsePosition() : ArrayList<Array<String>>? {
        ...
        for(iteration in iterations){
            ...
            rows.add(arrayOf(iteration.iteracion.toString(),df.format(iteration.x0).toString(),df.format(iteration.fxn).toString()))
