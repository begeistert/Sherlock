...
class FixedFragment : Fragment() {
    ...
    private var iterations : ArrayList<IteracionPF> = ArrayList()
    ...
    private fun getIterationsFalsePosition() : ArrayList<Array<String>>? {
        ...
        for(iteration in iterations){
            ...
            rows.add(arrayOf(iteration.ni.toString(),df.format(iteration.valueOf).toString(),df.format(iteration.ev).toString()))

            x0 = iteration.valueOf
