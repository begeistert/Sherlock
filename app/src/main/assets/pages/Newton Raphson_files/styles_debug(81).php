...
.gradingform_rubric.editor .criterion .controls .delete input {width:12px;height:12px;background: transparent url(/lms/moodle/theme/image.php?theme=aardvark_academica&component=core&image=t%2Fdelete) no-repeat center top; margin: .3em .3em 0 .3em;}
.gradingform_rubric.editor .levels .level .delete input {width:12px;height:16px;background: transparent url(/lms/moodle/theme/image.php?theme=aardvark_academica&component=core&image=t%2Fdelete) no-repeat center center; }
.dir-rtl .gradingform_rubric.editor .levels .level .delete input { margin-right: .45em; margin-left: 0; }
.gradingform_rubric.editor .moveup input {width:12px;height:12px;background: transparent url(/lms/moodle/theme/image.php?theme=aardvark_academica&component=core&image=t%2Fup) no-repeat center top; margin: .3em .3em 0 .3em; }
.gradingform_rubric.editor .movedown input {width:12px;height:12px;background: transparent url(/lms/moodle/theme/image.php?theme=aardvark_academica&component=core&image=t%2Fdown) no-repeat center top; margin: .3em .3em 0 .3em; }

.gradingform_rubric.editor .addcriterion input,
.gradingform_rubric.editor .addlevel input {background: transparent url(/lms/moodle/theme/image.php?theme=aardvark_academica&component=core&image=t%2Fadd) no-repeat top left ;display:block;color:#555555;font-weight:bold;text-decoration:none;}
