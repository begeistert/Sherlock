...
.path-mod-workshop .userplan tr.phasetasks li {
    background-image: url(/lms/moodle/theme/image.php?theme=aardvark_academica&component=mod_workshop&image=userplan%2Ftask-todo);
...
.path-mod-workshop .userplan tr.phasetasks li.completed {
    background-image: url(/lms/moodle/theme/image.php?theme=aardvark_academica&component=mod_workshop&image=userplan%2Ftask-done);
}

.path-mod-workshop .userplan tr.phasetasks li.fail {
    background-image: url(/lms/moodle/theme/image.php?theme=aardvark_academica&component=mod_workshop&image=userplan%2Ftask-fail);
}

.path-mod-workshop .userplan tr.phasetasks li.info {
    background-image: url(/lms/moodle/theme/image.php?theme=aardvark_academica&component=mod_workshop&image=userplan%2Ftask-info);
}
