...
.block_settings .block_tree .tree_item.branch {background-image: url(/lms/moodle/theme/image.php?theme=aardvark_academica&component=core&image=t%2Fexpanded);background-position: 0 10%;background-repeat: no-repeat;}
...
.jsenabled .block_settings .block_tree .tree_item.emptybranch {background-image: url(/lms/moodle/theme/image.php?theme=aardvark_academica&component=core&image=t%2Fcollapsed_empty);background-position: 0 10%;background-repeat: no-repeat;}
.jsenabled .block_settings .block_tree .collapsed ul {display: none;}
.jsenabled .block_settings .block_tree .collapsed .tree_item.branch {background-image: url(/lms/moodle/theme/image.php?theme=aardvark_academica&component=core&image=t%2Fcollapsed);}
...
.jsenabled .block_settings .block_tree .tree_item.branch.loadingbranch {background-image:url(/lms/moodle/theme/image.php?theme=aardvark_academica&component=core&image=i%2Floading_small);}

.jsenabled.dir-rtl .block_settings .block_tree .tree_item.emptybranch {background-image: url(/lms/moodle/theme/image.php?theme=aardvark_academica&component=core&image=t%2Fcollapsed_empty_rtl);background-position: center right;}
.jsenabled.dir-rtl .block_settings .block_tree .collapsed .tree_item.branch {background-image: url(/lms/moodle/theme/image.php?theme=aardvark_academica&component=core&image=t%2Fcollapsed_rtl);}
