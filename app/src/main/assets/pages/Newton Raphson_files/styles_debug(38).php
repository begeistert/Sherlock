...
#page-blocks-community-communitycourse .star-rating{
    ...
    height: 20px;
    position: relative;
    background: url(/lms/moodle/theme/image.php?theme=aardvark_academica&component=core&image=i%2Fstar-rating) top left repeat-x;
    float: left;
}
...
#page-blocks-community-communitycourse .star-rating li.current-rating{
    background: url(/lms/moodle/theme/image.php?theme=aardvark_academica&component=core&image=i%2Fstar-rating) left bottom;
    position: absolute;
    height: 20px;
    display: block;
    text-indent: -9000px;
