...
.gradingform_guide.editor .criterion .controls .delete input {width:20px;height:16px;background: transparent url(/lms/moodle/theme/image.php?theme=aardvark_academica&component=core&image=t%2Fdelete) no-repeat center top;margin-top:4px;}
.gradingform_guide.editor .moveup input {width:20px;height:15px;background: transparent url(/lms/moodle/theme/image.php?theme=aardvark_academica&component=core&image=t%2Fup) no-repeat center top;margin-top:4px;}
.gradingform_guide.editor .movedown input {width:20px;height:15px;background: transparent url(/lms/moodle/theme/image.php?theme=aardvark_academica&component=core&image=t%2Fdown) no-repeat center top;margin-top:4px;}

.gradingform_guide.editor .addcriterion input,
.gradingform_guide.editor .addcomment input {background: transparent url(/lms/moodle/theme/image.php?theme=aardvark_academica&component=core&image=t%2Fadd) no-repeat;display:block;color:#555555;font-weight:bold;text-decoration:none;}
.gradingform_guide.editor .addcriterion input,
...
.jsenabled .gradingform_guide .markingguidecomment:before {
    content: url(/lms/moodle/theme/image.php?theme=aardvark_academica&component=core&image=t%2Fadd);
    padding-right:2px;
}
