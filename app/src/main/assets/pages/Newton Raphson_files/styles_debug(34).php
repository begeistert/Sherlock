...
.path-mod-wiki .printicon {
    background: url(/lms/moodle/theme/image.php?theme=aardvark_academica&component=core&image=t%2Fprint) no-repeat scroll 2px center transparent; padding-left: 20px;
}
